class Solution20 {
    public int solution(int[] array) {
        ...
        for (int i = 0; i < array.length; i++) {  // 배열의 요소를 하나씩 확인하기 위한 반복문
            for (int j = i + 1; j < array.length; j++) {  // i 다음 인덱스부터 시작하여 다른 요소들과 비교하기 위한 반복문
                if (array[i] == array[j])  // 배열의 요소를 비교하여 일치하는지 확인
    ...
    public static void main(String[] args) {
        ...
        int result1 = s.solution(array1);  // solution 메소드 호출하여 일치하는 요소 개수 계산
